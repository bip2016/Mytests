...
then
    ...
    echo -e "rpm file:///mnt/repo/ALT/c7.1 x86_64 classic\nrpm file:///mnt/repo/ALT/c7.1 noarch classic\nrpm file:///mnt/repo/ALT/c7.1 x86_64-i586 classic" > /etc/apt/sources.list
else
    echo "Switch repository to local i586"
    echo -e "rpm file:///mnt/repo/ALT/c7.1 i586 classic\nrpm file:///mnt/repo/ALT/c7.1 noarch classic" > /etc/apt/sources.list
fi
apt-get clean
